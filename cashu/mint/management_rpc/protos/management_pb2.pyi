...
class Nut04Quote(_message.Message):
    __slots__ = ("quote", "method", "request", "checking_id", "unit", "amount", "state", "created_time", "paid_time", "expiry", "pubkey")
    ...
    expiry: int
    pubkey: str
    def __init__(self, quote: _Optional[str] = ..., method: _Optional[str] = ..., request: _Optional[str] = ..., checking_id: _Optional[str] = ..., unit: _Optional[str] = ..., amount: _Optional[int] = ..., state: _Optional[str] = ..., created_time: _Optional[int] = ..., paid_time: _Optional[int] = ..., expiry: _Optional[int] = ..., pubkey: _Optional[str] = ...) -> None: ...
...
class RotateNextKeysetRequest(_message.Message):
    __slots__ = ("unit", "max_order", "input_fee_ppk")
    UNIT_FIELD_NUMBER: _ClassVar[int]
    ...
    max_order: int
    input_fee_ppk: int
    def __init__(self, unit: _Optional[str] = ..., max_order: _Optional[int] = ..., input_fee_ppk: _Optional[int] = ...) -> None: ...

class RotateNextKeysetResponse(_message.Message):
    __slots__ = ("id", "unit", "max_order", "input_fee_ppk")
    ID_FIELD_NUMBER: _ClassVar[int]
    UNIT_FIELD_NUMBER: _ClassVar[int]
    MAX_ORDER_FIELD_NUMBER: _ClassVar[int]
    INPUT_FEE_PPK_FIELD_NUMBER: _ClassVar[int]
    ...
    max_order: int
    input_fee_ppk: int
    def __init__(self, id: _Optional[str] = ..., unit: _Optional[str] = ..., max_order: _Optional[int] = ..., input_fee_ppk: _Optional[int] = ...) -> None: ...
...
class GetPendingInvoicesRequest(_message.Message):
    __slots__ = ("unit",)
    UNIT_FIELD_NUMBER: _ClassVar[int]
    unit: str
    def __init__(self, unit: _Optional[str] = ...) -> None: ...

class PendingInvoice(_message.Message):
    __slots__ = ("payment_hash", "amount_msat", "created")
    PAYMENT_HASH_FIELD_NUMBER: _ClassVar[int]
    ...
    amount_msat: int
    created: int
    def __init__(self, payment_hash: _Optional[str] = ..., amount_msat: _Optional[int] = ..., created: _Optional[int] = ...) -> None: ...

class GetPendingInvoicesResponse(_message.Message):
    __slots__ = ("invoices",)
    INVOICES_FIELD_NUMBER: _ClassVar[int]
    invoices: _containers.RepeatedCompositeFieldContainer[PendingInvoice]
    def __init__(self, invoices: _Optional[_Iterable[_Union[PendingInvoice, _Mapping]]] = ...) -> None: ...

class SettleArbitraryPaymentRequest(_message.Message):
    __slots__ = ("checking_id",)
    CHECKING_ID_FIELD_NUMBER: _ClassVar[int]
    checking_id: str
    def __init__(self, checking_id: _Optional[str] = ...) -> None: ...

class SettleArbitraryPaymentResponse(_message.Message):
    __slots__ = ("success", "error")
    SUCCESS_FIELD_NUMBER: _ClassVar[int]
    ERROR_FIELD_NUMBER: _ClassVar[int]
    success: bool
...
class RejectArbitraryPaymentRequest(_message.Message):
    __slots__ = ("checking_id",)
    CHECKING_ID_FIELD_NUMBER: _ClassVar[int]
    checking_id: str
    def __init__(self, checking_id: _Optional[str] = ...) -> None: ...

class RejectArbitraryPaymentResponse(_message.Message):
    __slots__ = ("success", "error")
    SUCCESS_FIELD_NUMBER: _ClassVar[int]
    ERROR_FIELD_NUMBER: _ClassVar[int]
    success: bool
...
class GetPendingArbitraryPaymentsRequest(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class PendingArbitraryPayment(_message.Message):
    __slots__ = ("checking_id", "request", "identifier", "amount", "status")
    CHECKING_ID_FIELD_NUMBER: _ClassVar[int]
    REQUEST_FIELD_NUMBER: _ClassVar[int]
    ...
    amount: int
    status: str
    def __init__(self, checking_id: _Optional[str] = ..., request: _Optional[str] = ..., identifier: _Optional[str] = ..., amount: _Optional[int] = ..., status: _Optional[str] = ...) -> None: ...

class GetPendingArbitraryPaymentsResponse(_message.Message):
    __slots__ = ("payments",)
    PAYMENTS_FIELD_NUMBER: _ClassVar[int]
    payments: _containers.RepeatedCompositeFieldContainer[PendingArbitraryPayment]
    def __init__(self, payments: _Optional[_Iterable[_Union[PendingArbitraryPayment, _Mapping]]] = ...) -> None: ...
