...
# NUT #00: `amount` is the value of the blinded token, `id` is the [keyset id][02] of the mint keys that signed the token, and `C_` is the blinded signature on the secret message `B_` sent in the previous step.
